...
def speculative_sampling(prefix : torch.Tensor, approx_model : torch.nn.Module, target_model : torch.nn.Module, 
                         max_len : int , gamma : int = 20,
                         temperature : float = 0.000000000000000000000000001, top_k : int = 0, top_p : float = 0, verbose : bool = False, random_seed : int = None) -> torch.Tensor:
    """
...
def speculative_sampling_v2(prefix : torch.Tensor, approx_model : torch.nn.Module, target_model : torch.nn.Module, 
                         ...
                         temperature : float = 0.000000000000000001, top_k : int = 0, top_p : float = 0, random_seed : int = None) -> torch.Tensor:
    """
